...
cumulative optimize/cmaes_all_evaluations.csv / visualization/
...
LOG_DIR = os.path.join(_ROOT, "optimize", "focused_refinement_logs")
SUMMARY_LOG = os.path.join(_ROOT, "optimize", "focused_refinement_log.txt")
