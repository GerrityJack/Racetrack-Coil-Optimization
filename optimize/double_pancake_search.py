...
the same cumulative optimize/cmaes_all_evaluations.csv / visualization/
...
LOG_DIR = os.path.join(_ROOT, "optimize", "double_pancake_logs")
SUMMARY_LOG = os.path.join(_ROOT, "optimize", "double_pancake_log.txt")
RESULTS_CSV = os.path.join(_ROOT, "optimize", "double_pancake_results.csv")
HISTORY_CSV = os.path.join(_ROOT, "optimize", "double_pancake_history.csv")
