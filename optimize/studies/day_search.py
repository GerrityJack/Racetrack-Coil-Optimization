...
LOG_PATH = os.path.join(_ROOT, "optimize", "runs", "day_search", "day_search_log.txt")
LOGS_DIR = os.path.join(_ROOT, "optimize", "runs", "day_search", "day_search_logs")
RESULTS_CSV = os.path.join(_ROOT, "optimize", "runs", "day_search", "day_search_results.csv")
HISTORY_CSV = os.path.join(_ROOT, "optimize", "runs", "day_search", "day_search_history.csv")
REPORT_PATH = os.path.join(_ROOT, "optimize", "runs", "day_search", "day_search_report.md")
...
def _run_cmaes_job(job_name, x0, seed, max_evals, cap_minutes, extra_env=None):
    ...
    results_csv = os.path.join(_ROOT, "optimize", "runs", "day_search", f"day_search_{job_name}_results.csv")
    history_csv = os.path.join(_ROOT, "optimize", "runs", "day_search", f"day_search_{job_name}_history.csv")
