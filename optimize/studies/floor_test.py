...
optimize/runs/cmaes_all_evaluations.csv as any other cmaes_search.py run --
...
# optimize/runs/cmaes_all_evaluations.csv). Kept at full precision.
JOBS = [
...
LOG_DIR = os.path.join(_ROOT, "optimize", "runs", "floor_test", "floor_test_logs")
SUMMARY_LOG = os.path.join(_ROOT, "optimize", "runs", "floor_test", "floor_test_log.txt")
