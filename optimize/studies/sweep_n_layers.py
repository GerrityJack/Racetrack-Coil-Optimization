...
SWEEP_LOG = os.path.join(_ROOT, "optimize", "runs", "sweep_n_layers", "sweep_n_layers_log.txt")
SWEEP_LOGS_DIR = os.path.join(_ROOT, "optimize", "runs", "sweep_n_layers", "sweep_n_layers_logs")
