"""
jitter_new_design.py -- build-tolerance study of the 2026-07-31 design
======================================================================
Does the new design (a=23.227mm, b=28.268mm, gap=13.500mm,
n_turns=[329,329,411,411,2,2], I_op=204.57A) survive realistic
manufacturing error?
...
RUN_DIR = os.path.join(_ROOT, "optimize", "runs", "jitter_new_design")
...
# nominal design
NOM = dict(a=0.023227029065529628, b=0.02826822715975084,
           gap=0.013500289306395013, t=75e-6,
