...
optimize/runs/cmaes_all_evaluations.csv (the cumulative "parameter-space map"
...
All evaluations still accumulate into optimize/runs/cmaes_all_evaluations.csv
...
SWEEP_LOG = os.path.join(_ROOT, "optimize", "runs", "sweep_restarts", "sweep_restarts_log.txt")
SWEEP_LOGS_DIR = os.path.join(_ROOT, "optimize", "runs", "sweep_restarts", "sweep_logs")
