...
def main():
    ...
    basis_lines = [
        ...
        "",
        "NEW 2026-08-08: first-ever ramp-DOWN run of the T-A solver",
        "(196A -> ~2A). Clean throughout (dB_rel 0.003-0.015, all steps",
        "finite). SCIF crosses zero and settles at a nonzero remanent",
        "value of the sign Bean critical-state theory predicts -- 2.1x",
        "the analytical remanent fraction (qualitative match, not exact --",
        "expected for a 1-D idealized-slab comparison). This comparison",
        "also caught and fixed a real bug in the analytical derivation.",
    ]
    ...
    figs_lines = [
        ...
        "06  Simulated T-A ramp-down vs. analytical loop (NEW)",
